  ...
  return (
    <AppLayout breadcrumbs={[{ label: "Admin", href: "/admin" }, { label: "Assessments" }]} role="admin">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card><CardContent className="p-4 text-center"><p className="text-3xl font-bold text-primary">82%</p><p className="text-xs text-gray-500">Pass Rate</p></CardContent></Card>
        <Card><CardContent className="p-4 text-center"><p className="text-3xl font-bold text-primary">67%</p><p className="text-xs text-gray-500">Avg Score</p></CardContent></Card>
        <Card><CardContent className="p-4 text-center"><p className="text-3xl font-bold text-primary">1,240</p><p className="text-xs text-gray-500">Assessments Taken</p></CardContent></Card>
        <Card><CardContent className="p-4 text-center"><p className="text-3xl font-bold text-primary">8.2</p><p className="text-xs text-gray-500">Avg Questions/Assessment</p></CardContent></Card>
      </div>
            ...
            <div className="space-y-3">
              {[{ name: "SQL", score: 72, pass: 85 }, { name: "Python", score: 58, pass: 68 }, { name: "Survey Design", score: 74, pass: 88 }, { name: "Data Viz", score: 65, pass: 78 }, { name: "AI/ML", score: 42, pass: 52 }].map((c) => (
                <div key={c.name} className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-600">Avg: {c.score}%</span>
